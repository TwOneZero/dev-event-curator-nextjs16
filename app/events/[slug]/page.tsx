  ...
  return (
    <section id="event">
      <div className="header">
        ...
        <div className="mt-6">
          <Link
            href={`/delete-event/${slug}`}
            className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-500 rounded-lg border border-red-500/30 transition-all duration-200 text-sm font-medium"
          >
            <svg
